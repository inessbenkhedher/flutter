...
final List<InstagramPostData> instagramPosts = [
  InstagramPostData(
    postAsset: "assets/images/ta1.jpg", // Ajoutez l'URL de l'image
    productName: "Produit 1",
    price: "10", // Prix du produit
  ),
  InstagramPostData(
    postAsset: "assets/images/ta2.jpg", // Ajoutez l'URL de l'image
    productName: "Produit 2",
    price: "20", // Prix du produit
  ),
  InstagramPostData(
    postAsset: "assets/images/ta3.jpg", // Ajoutez l'URL de l'image
    productName: "Produit 2",
    price: "20", // Prix du produit
  ),
  InstagramPostData(
    postAsset: "assets/images/ta4.jpg", // Ajoutez l'URL de l'image
    productName: "Produit 2",
    price: "20", // Prix du produit
  ), InstagramPostData(
    postAsset: "assets/images/ta5.jpg", // Ajoutez l'URL de l'image
    productName: "Produit 2",
    price: "20", // Prix du produit
  ),InstagramPostData(
    postAsset: "assets/images/ta6.jpg", // Ajoutez l'URL de l'image
    productName: "Produit 2",
    price: "20", // Prix du produit
  ),
